...
If that link doesn't work, the front-end demo is also viewable on Github pages: [UnsureTA UI Demo](https://rentalsatyr8499.github.io/AI-Powered-Rubric-Assistant/)
